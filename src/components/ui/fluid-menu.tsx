  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 cursor-pointer rounded-full group will-change-transform z-50 shadow-lg hover:shadow-xl transition-shadow"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-700 dark:to-gray-800 will-change-transform shadow-lg"
            style={{
